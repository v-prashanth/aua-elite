...
export default function MarketingError({
  ...
  return (
    <>
      <Navbar />
      <main className="flex-grow pt-[72px] lg:pt-[84px] min-h-[70vh] flex items-center justify-center px-6 py-24">
        <div className="max-w-lg text-center">
          ...
          <div className="relative z-10">
            ...
            <p
              className="font-display font-medium text-navy-primary/8 dark:text-white/5 select-none leading-none mb-6"
            ...
            <p className="text-sm text-silver dark:text-white/50 font-sans leading-relaxed mb-10 max-w-sm mx-auto">
              An unexpected error occurred on this page. Please try refreshing
